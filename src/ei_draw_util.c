...
ei_linked_point* arc(ei_point_t centre, int rayon, int angleDebut, int angleFin, int nbPoints)
{
...
ei_linked_point* rounded_frame(ei_rect_t rect,int rayon,bool partieHaute,bool partieBasse)
{
  ei_point_t centre1;
